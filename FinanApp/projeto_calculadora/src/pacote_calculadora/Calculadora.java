 ...
 * 
 * <p>Esta classe fornece operações matemáticas basicas como soma, subtração, multiplicação e divisão, além de um
 * método principal que seleciona a operação desejada com base em um operador informado pelo usuário.</p>
 * <p>Esse projeto é utilizado para apresentar:</p>
 * <ul>
 ...
 * sem efeitos colaterais, permitindo maior legibilidade e facilitando os testes unítarios.</p>
 * 
 * @author Pedro Henrique Chagas do Nascimento
 * @version 1.0
 */
...
public class Calculadora {
    ...
    /**
     * <p>Executa a operação desejada com base no operador informado.</p>
     * 
